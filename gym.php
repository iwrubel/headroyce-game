<?php 
    ...
    if ($choice == 'choice1')
    {
        $_SESSION['grades']+=30;
        $_SESSION['stress']+=10;
        header('Location: https://javascript-game-catherinemcmahon.c9users.io/field.php');
...
<html>
    ...
    <img id='doll' src='images/doll.jpg' style='position:absolute; display: none;' />
            ...
            <div id="Location" class="modalDialog">
                <div class="col-sm-12">
                    ...
                    <h1 class="lead">You are in at the HRS gym</h1>
                </div>
            </div> 
            <!-- Modal 2 -->
                    ...
                    <table class="table table-bordered" style="margin-top:10px;">
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="progress">
			                      <div id="Sleep" class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" style="width:30%; background-color: #00D7D7;">
                        ...
                        <tr>
                            ...
                            <td>
                                <span style="color:#009900">.......................</style>
                                <div class="progress">
			                      <div id="Nutrition" class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width:70%; background-color:orange;">
			                        <span class="sr-only"></span>
			                      </div>
		                    	</div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span style="color:#009900">.......................</style>
                                <div class="progress">
			                      <div id="Stress" class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width:80%; background-color:#FF6347;">
			                        <span class="sr-only"></span>
			                      </div>
		                    	</div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span style="color:#009900">.......................</style>
                                <div class="progress">
			                      <div id="Grades" class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100" style="width:85%; background-color:green;">
			                        <span class="sr-only"></span>
			                      </div>
		                    	</div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span style="color:#009900">.......................</style>
                                <div class="progress">
			                      <div id="Social Life" class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="94" aria-valuemin="0" aria-valuemax="100" style="background-color: #FF14FF; width:94%;">
			                        <span class="sr-only"></span>
			                      </div>
		                    	</div>
                            </td>
    ...
    <img id='bg' src='images/gym.jpg' style='display:none; position:absolute;'>
   ...
   // context.font = "20px Cambria";
    ...
    <!-- <div class="options" style="position:relative; display:inline-block; float:right; margin-right:200px; margin-top:420px;">
        ...
        <div id="StoryRect" class="well" style=" min-height: 60px; float: bottom; position:absolute; background-color:gold; margin-left: 200px; margin-top: 140px; opacity:0.9;">
            <h1 class="lead"><strong>3:20pm</strong> What would you like to do for the next hour?</h1>
            <form action="gym.php" name="RoomActivities" method="POST" class="form-horizontal">
				<h3 class="lead"><input type="radio" name="choice" value="choice1">  Go home and study<br>
				<input type="radio" name="choice" value="choice2">  Go home and sleep<br>
				<input type="radio" name="choice" value="choice3">  Have a snack and workout<br>
				<input type="radio" name="choice" value="choice4">  Hangout with friends<br><br></h3>
