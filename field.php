<?php 
    ...
    if ($choice == 'choice1')
    {
        ...
        $_SESSION['stress']+=20;
        $_SESSION['social']-=5;
        header('Location: https://javascript-game-catherinemcmahon.c9users.io/starterroom.html');
...
<html>
    ...
    <img id='doll' src='images/doll.jpg' style='position:absolute; display: none;' />
            ...
            <div id="Location" class="modalDialog">
                <div class="col-sm-12">
                    ...
                    <h1 class="lead">You are at the field where the softball team slays and Zay racks up the mileage.</h1>
                </div>
            </div> 
            <!-- Modal 2 -->
    ...
    <img id='bg' src='images/field.jpg' style='display:none; position:absolute;'>
    ...
    <nav class="navbar navbar-inverse" style="background-color:green">
      <div class="container-fluid">
        ...
        <div id="StoryRect" class="well" style=" min-height: 60px; float: bottom; position:absolute; background-color:gold; margin-left: 200px; margin-top: 140px; opacity:0.9;">
            <h1 class="lead"><strong>5:10pm</strong> What would you like to do for the next hour?</h1>
            <form action="field.php" name="RoomActivities" method="POST" class="form-horizontal">
				<h3 class="lead"><input type="radio" name="choice" value="choice1"> Study<br>
				<input type="radio" name="choice" value="choice2"> Go to a Jayhawk Outing<br>
				<input type="radio" name="choice" value="choice3"> Eat Dinner<br>
				<input type="radio" name="choice" value="choice4"> Watch Youtube<br></h3>
