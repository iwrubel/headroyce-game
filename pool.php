<?php 
    ...
    if ($choice == 'choice1')
    {
        $_SESSION['nutrition']+=30;
        $_SESSION['stress']-=10;
        $_SESSION['social']-=5;
        header('Location: https://javascript-game-catherinemcmahon.c9users.io/gym.php');
...
<html>
    ...
    <img id='doll' src='images/doll.jpg' style='position:absolute; display: none;' />
            ...
            <div id="Location" class="modalDialog">
                <div class="col-sm-12">
                    ...
                    <h1 class="lead">You are in at the HRS gym where Zaytoveen drops buckets</h1>
                </div>
            </div> 
            <!-- Modal 2 -->
                    ...
                    <table class="table table-bordered" style="margin-top:10px;">
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="progress">
			                      <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" style="width:30%; background-color: #00D7D7;">
                        ...
                        <tr>
                            ...
                            <td>
                                <span style="color:#009900">.......................</style>
                                <div class="progress">
			                      <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width:70%; background-color:orange;">
			                        <span class="sr-only"></span>
			                      </div>
		                    	</div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span style="color:#009900">.......................</style>
                                <div class="progress">
			                      <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width:80%; background-color:#FF6347;">
			                        <span class="sr-only"></span>
			                      </div>
		                    	</div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span style="color:#009900">.......................</style>
                                <div class="progress">
			                      <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100" style="width:85%; background-color:green;">
			                        <span class="sr-only"></span>
			                      </div>
		                    	</div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span style="color:#009900">.......................</style>
                                <div class="progress">
			                      <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="94" aria-valuemin="0" aria-valuemax="100" style="background-color: #FF14FF; width:94%;">
			                        <span class="sr-only"></span>
			                      </div>
		                    	</div>
                            </td>
    ...
    <img id='bg' src='images/pool.jpg' style='display:none; position:absolute;'>
    ...
    <!-- <div class="options" style="position:relative; display:inline-block; float:right; margin-right:200px; margin-top:420px;">
        ...
        <a class="btn btn-lg" href="#" style="background-color:red; color:gold;">No</a>
         ...
         <div id="StoryRect" class="well" style=" min-height: 60px; float: bottom; position:absolute; background-color:gold; margin-left: 200px; margin-top: 140px; opacity:0.9;">
            <h1 class="lead"><strong>12:30pm</strong> Its lunch time! What do you want to do?</h1>
            <form action="pool.php" name="RoomActivities" method="POST" class="form-horizontal">
				<h3 class="lead"><input type="radio" name="choice" value="choice1">  Eat a ton of lunch<br>
				<input type="radio" name="choice" value="choice2"> Go for a swim<br>
				<input type="radio" name="choice" value="choice3"> Hangout with friends around the pool<br>
				<input type="radio" name="choice" value="choice4"> Study at the library<br><br>
